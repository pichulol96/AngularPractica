...
@Component({
  selector: 'app-lista-bajas',
  templateUrl: './lista-bajas.component.html',
  styleUrls: ['./lista-bajas.component.css']
})
export class ListaBajasComponent implements OnInit {
 ...
 listas:any;
  ...
  constructor(private ResguardoService:ResguardoService,
    ...
    searchArticulos()
    {
     //alert(this.search+' :'+this.filtro);
       ...
       else
       {
        ...
        let resul=this.InventarioService.listadoBajas(consulta).subscribe(data=>{
         this.articulos=data;
           if(this.articulos=='')
           {
             Swal.fire(
